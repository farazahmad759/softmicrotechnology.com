    ...
    <div class="slider-parallax-inner">
        ...
        <div class="swiper-container swiper-parent">
            <div class="swiper-wrapper">
                <div class="swiper-slide dark" style="background-image: url('images/slider/swiper/1_1.jpg');">
                    <div class="container clearfix">
                        <div class="slider-caption slider-caption-center">
                            <h2 data-caption-animate="fadeInUp">Welcome to Canvas</h2>
                            <p data-caption-animate="fadeInUp" data-caption-delay="200">Create just what you need for
                                your Perfect Website. Choose from a wide range of Elements &amp; simply put them on your
                                own Canvas.</p>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide dark">
                    <div class="container clearfix">
                        <div class="slider-caption slider-caption-center">
                            ...
                            <p data-caption-animate="fadeInUp" data-caption-delay="200">Looks beautiful &amp;
                ...
                <div class="swiper-slide"
                    ...
                    <div class="container clearfix">
                        <div class="slider-caption">
                            ...
                            <p data-caption-animate="fadeInUp" data-caption-delay="200">You'll be surprised to see the
